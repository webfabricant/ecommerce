                                ...
                                <tr class="cart_item">
                                    ...
                                    <td class="product-thumbnail">
                                        ...
                                        <div class="cart-product__item">
                                            <a>
                                                <img src="{{ asset($pdt->model->image) }}" alt="product" width="70px" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image">
                                            </a>
                                    ...
                                    <td class="product-quantity">
                                        ...
                                        <div class="quantity">
                                            <a href="{{ route('cart.reduce', ['id' => $pdt->rowId, 'qty' => $pdt->qty]) }}" class="quantity-minus">-</a>
